...
## This was tested against GeForce Experience 3.20.5.70. libcef might not change that frequently.
...
if($file[$offset] -eq 4 -and $file[$offset+2] -eq 5 -and $file[$offset+4] -eq 8) {
	Stop-Process -Name "NVIDIA GeForce Experience"
	Stop-Process -Name "NVIDIA Share"
